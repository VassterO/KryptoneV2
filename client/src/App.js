...
// Componente para envolver cada página con animaciones de transición
...
const App = () => {
    ...
    useEffect(() => {
        // Desplazarse al inicio de la página en el cambio de ruta
        window.scrollTo(0, 0);
    }, [location]);
    ...
    return (
        <div className="bg-gray-900 min-h-screen flex flex-col">
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Kryptone Facilities - SCP: Secret Laboratory Server"
                />
            </Helmet>
            {/* Barra de navegación */}
            <Navbar />
...
// Envolver la aplicación con el enrutador
const AppWrapper = () => (
    <Router>
        <App />
    </Router>
