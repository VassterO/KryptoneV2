        ...
        <>
            ...
            <header className="bg-gradient-to-b from-gray-900 via-gray-900 to-transparent text-white p-4 flex items-center justify-between sticky top-0 z-50">
                ...
                <nav id="navbar-links" className={`lg:flex items-center ${isOpen ? 'block' : 'hidden'} lg:block`}>
                    <Link to="/" className="block py-2 lg:inline-block hover:text-gray-400 transition duration-300 ease-in-out transform hover:scale-105 border-b-2 border-transparent hover:border-blue-500 rounded" onClick={closeMenu}>
                        Inicio
                    </Link>
                    <Link to="/ranks" className="block py-2 lg:inline-block hover:text-gray-400 transition duration-300 ease-in-out transform hover:scale-105 border-b-2 border-transparent hover:border-blue-500 rounded" onClick={closeMenu}>
                        Rangos
                    </Link>
                    <Link to="/profile" className="block py-2 lg:inline-block hover:text-gray-400 transition duration-300 ease-in-out transform hover:scale-105 border-b-2 border-transparent hover:border-blue-500 rounded" onClick={closeMenu}>
                        Perfil
                    </Link>
                </nav>
            </header>
