        ...
        <nav className="bg-gray-800 bg-opacity-75 p-4 shadow-md fixed w-full z-10">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center">
                    <img src={logo} alt="Logo" className="h-12 w-12 mr-4"/> {/* Adjust the size as needed */}
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <Link to="/login" className="bg-blue-500 text-white px-4 py-2 rounded">Login with Patreon</Link>
                </div>
            </div>
        </nav>
    );
